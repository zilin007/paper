...
![三种轻量化微调方案对比](./resource/finetune_comparison.svg)
...
![LoRA 在 Transformer Block 中的位置](./resource/lora_in_transformer.svg)
...
![LoRA 前向传播数据流](./resource/lora_forward_pass.svg)
...
![LoRA 梯度流向](./resource/lora_gradient_flow.svg)
...
![训练迭代全景图](./resource/training_iteration_overview.svg)
